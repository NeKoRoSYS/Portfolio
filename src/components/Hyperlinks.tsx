...
export function TextHyperlink({
  ...
  const classOverride = cn(
    "duration-75 not-sm:touch-hover:-translate-y-1 sm:touch-hover:translate-x-1 text-zinc-400 touch-hover:text-foreground flex flex-row items-center gap-2 group",
    className,
  );
  const linkInner = (
    <>

...
export function Header() {
  ...
  return (
    <>
      ...
      />
      <div className="fixed top-0 left-0 z-1 flex w-full items-center justify-center">
        <header
          className={`${baseHeader} ${!onTop ? bgVisible : `${bgVisible} ${bgInvisible}`}`}
        >
          <div className="flex w-full items-center justify-between px-4 py-8">
            ...
            <nav className={`hidden sm:block`}>
              ...
              >
                <AnimatedBackground
                  className="rounded-full bg-zinc-100 dark:bg-white"
                  transition={{
                    type: "spring",
                    bounce: 0,
                    duration: 0.25,
            ...
            <HoverableElement
              className="hidden rounded-3xl bg-white text-zinc-900 transition-all duration-200 sm:flex"

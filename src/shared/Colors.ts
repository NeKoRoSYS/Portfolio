export const BRAND_COLORS = {
  ...
  bitcoin:
    "border-amber-500/80 touch-hover:border-amber-400 bg-linear-to-b from-amber-900/40 to-amber-600/50 touch-hover:from-amber-500/50 touch-hover:to-amber-700/30 touch-hover:drop-shadow-[0_0_8px_rgba(247,147,26,0.6)]",
  discord:
    "border-indigo-500/80 touch-hover:border-indigo-400 bg-linear-to-b from-indigo-900/30 to-indigo-600/50 touch-hover:from-indigo-500/50 touch-hover:to-indigo-700/30 touch-hover:drop-shadow-[0_0_8px_rgba(114,137,218,0.5)]",
  ethereum:
    "border-purple-500/60 touch-hover:border-indigo-300 bg-linear-to-b from-slate-800/50 to-indigo-950/40 touch-hover:from-indigo-500/40 touch-hover:to-purple-500/20 touch-hover:drop-shadow-[0_0_8px_rgba(140,124,240,0.5)]",
  facebook:
  ...
  instagram:
    "border-fuchsia-500/80 touch-hover:border-orange-400 bg-linear-to-b from-purple-900/40 to-pink-600/50 touch-hover:from-fuchsia-500/50 touch-hover:to-orange-500/30 touch-hover:drop-shadow-[0_0_8px_rgba(225,48,108,0.5)]",
  itchio:
    "border-red-500/80 touch-hover:border-[#fa5c5c] bg-linear-to-b from-red-950/40 to-red-800/50 touch-hover:from-[#fa5c5c]/50 touch-hover:to-red-800/30 touch-hover:drop-shadow-[0_0_8px_rgba(250,92,92,0.6)]",
  kofi: "border-rose-500/80 touch-hover:border-rose-400 bg-linear-to-b from-rose-900/40 to-rose-600/50 touch-hover:from-rose-500/50 touch-hover:to-rose-700/30 touch-hover:drop-shadow-[0_0_8px_rgba(255,94,96,0.5)]",
  linkedin:
    "border-blue-600/80 touch-hover:border-blue-400 bg-linear-to-b from-blue-900/40 to-blue-700/50 touch-hover:from-blue-600/50 touch-hover:to-blue-800/30 touch-hover:drop-shadow-[0_0_8px_rgba(0,119,181,0.5)]",
  payhip:
    "border-emerald-500/80 touch-hover:border-emerald-400 bg-linear-to-b from-emerald-900/40 to-emerald-700/50 touch-hover:from-emerald-500/50 touch-hover:to-emerald-800/30 touch-hover:drop-shadow-[0_0_8px_rgba(0,185,108,0.5)]",
  paypal:
    "border-sky-600/80 touch-hover:border-blue-400 bg-linear-to-b from-blue-900/40 to-sky-600/50 touch-hover:from-sky-400/50 touch-hover:to-blue-600/30 touch-hover:drop-shadow-[0_0_8px_rgba(0,112,186,0.5)]",
  tiktok:
...
export const Colors = {
  ...
  indicatorPulseGreen:
    "bg-[#27e844] animate-pulse shadow-[0_0_10px_rgba(57,255,20,1)]",
  indicatorPulseYellow:
    "bg-[#f2f75c] animate-ping shadow-[0_0_10px_rgba(255,255,0,1)]",
